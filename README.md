...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python_version-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14342&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python_version-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python_version` can be installed with:

```
conda install python_version
```

It is possible to list all of the versions of `python_version` available on your platform with:
